...
public class ListItemsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //------------------
        aSwitch = (Switch) findViewById(R.id.switchID_listItem);
...
//                Toast toast = Toast.makeText(getApplicationContext(), charSequence, duration);
        ...
        //-------------------
        checkBox =(CheckBox)findViewById(R.id.checkBoxID_ListItem);
        ...
        //-------------------
        imageButton = (ImageButton)findViewById(R.id.imageButtonID_listItem);
